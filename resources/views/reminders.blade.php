...
<head>
    ...
    <title>Reminders - Time & Productivity Analyzer</title>
...
<body class="bg-slate-900 text-slate-200 antialiased selection:bg-indigo-500 selection:text-white" x-data="{ sidebarOpen: false, addModalOpen: false, currentTab: 'active' }">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="absolute inset-y-0 left-0 z-50 w-64 transform bg-slate-900/50 backdrop-blur-xl border-r border-slate-800 transition-transform duration-300 ease-in-out lg:static lg:translate-x-0"
            ...
            <nav class="p-4 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('reminders.index') }}" class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 transition-all duration-200">
            ...
            <header class="h-20 px-6 flex items-center justify-between border-b border-slate-800 bg-slate-900/50 backdrop-blur-xl z-40 sticky top-0">
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative hidden sm:block">
                        ...
                        <input type="text" placeholder="Search reminders..." class="w-80 bg-slate-800/50 border border-slate-700/50 text-slate-200 text-sm rounded-full pl-10 pr-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all placeholder-slate-500">
                    </div>
                </div>
