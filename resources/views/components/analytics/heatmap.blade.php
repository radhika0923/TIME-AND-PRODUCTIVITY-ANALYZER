...
<div class="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-[2rem] p-6 shadow-sm dark:shadow-none mb-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
        <div>
            <h2 class="text-lg font-bold text-gray-900 dark:text-white">Focus Heatmap</h2>
            <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Your focus intensity over the last 365 days.</p>
        </div>
        <div class="flex items-center gap-2 text-[10px] text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest">
            <span>Less</span>
    ...
    <div class="flex justify-between mt-4 text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest px-1">
